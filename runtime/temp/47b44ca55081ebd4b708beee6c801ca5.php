<?php /*a:1:{s:63:"E:\www-web\ThinkPHP_CMS\application\admin\view\login\login.html";i:1530780180;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
        ...
        <ul>
            ...
            <li>
                <div class="form-group">
                    ...
                    />
                    <img src="<?php echo captcha_src(); ?>" alt="captcha" id="captcha" onclick="this.src='<?php echo captcha_src(); ?>?rnd=' + Math.random();" alt="">
                </div>
            </li>
            <!--<li>
            ...
            if ($('#adminName').val() == '') {
                ...
                $.post('<?php echo url("Login/login_do"); ?>', {username: username, password: password,verify:verify}, function (data) {
                    if (data.status == 200) {
                        ...
                        layer.msg(data.tips);
                        $('#captcha').attr('src','<?php echo captcha_src(); ?>?rnd=' + Math.random());
                    }
                })
            }
        });
