<?php /*a:6:{s:70:"E:\www-web\ThinkPHP_CMS\application\admin\view\admin\editor_admin.html";i:1529550058;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\static.html";i:1529542576;s:63:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\menu.html";i:1528855708;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\header.html";i:1529387612;s:62:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\nav.html";i:1528625773;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\footer.html";i:1529573972;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
                            ...
                            <div class="tab-cont" style="display: block;">
                                <form id="form_data">
                                    ...
                                    <div class="form-group-col-2">
                                        ...
                                        <div class="form-cont">
                                            <label class="radio">
                                                <input type="radio" name="status" value="1" <?php if(1 == $info['status']): ?>checked<?php endif; ?>  />
                                                <span>正常</span>
                                            </label>
                                            <label class="radio">
                                                <input type="radio" name="status" value="0" <?php if(0 == $info['status']): ?>checked<?php endif; ?> />
                                                <span>禁止</span>
                                            </label>
                            ...
                            <div class="tab-cont">
                                <form id="form_group">
                                    ...
                                    <div class="form-group-col-2">
                                        <div class="form-label">名称：</div>
                                        <div class="form-cont">
                                            <input type="text" value="<?php echo htmlentities($info['username']); ?>" name="username" class="form-control form-boxed" disabled style="width:300px;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-col-2">
                                        ...
                                        <div class="form-cont" >
                                            <select style="width:auto;" name="group_id">
                                                ...
                                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if($v['id'] == $group_access['group_id']): ?>selected<?php endif; ?> >
