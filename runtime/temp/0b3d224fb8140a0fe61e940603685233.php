<?php /*a:6:{s:69:"E:\www-web\ThinkPHP_CMS\application\admin\view\users\users_index.html";i:1530710945;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\static.html";i:1529542576;s:63:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\menu.html";i:1528855708;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\header.html";i:1529387612;s:62:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\nav.html";i:1528625773;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\footer.html";i:1529573972;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
        ...
        <a href="">首页</a> > <a href=""><?php echo htmlentities($controller_name); ?></a> > <a href=""><?php echo htmlentities($action_name); ?></a>
                ...
                <div class="clear mt-20" style="padding-bottom: 20px;margin-top: -10px">
                    ...
                    <div class="fr input-group">
                        <form action="" method="get">
                            <input type="text" name="search" class="form-control" placeholder="搜索用户名..." style="width:290px;"/>
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tr class="cen">
                        ...
                        <td ><?php echo htmlentities($v['integral']); ?></td>
                        <td><?php echo htmlentities($v['phone']); ?></td>
                        <td><?php echo htmlentities($v['email']); ?></td>
                        <td><?php echo htmlentities($v['qq']); ?></td>
                        <td><?php echo htmlentities($v['wx']); ?></td>
...
<script type="text/javascript">
    ...
    function del(obj, id) {
        layer.confirm('确定删除吗？', {
            ...
            $.post('<?php echo url("Users/del_user"); ?>', {id: id}, function (data) {
                // 判断是否成功
                if (data.status == 200) {
    ...
    function editor(obj, id) {
        $.get('<?php echo url("Users/editor_user"); ?>',{id:id}, function (data) {
            // 判断是否成功
            if (data.status == 400) {
                layer.msg(data.tips);
            } else {
                location.href = "<?php echo url('Users/editor_user'); ?>" + "?id=" + id;
            }
        });
    }
</script>
