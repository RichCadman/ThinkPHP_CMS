        ...
        <a href="">首页</a> > <a href=""><?php echo htmlentities($controller_name); ?></a> > <a href=""><?php echo htmlentities($action_name); ?></a>
                ...
                <form id="form_data">
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" id="username" name="username" class="form-control form-boxed"  style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="password" placeholder="建议：6-12位数字、字母组合密码" id="password" name="password" class="form-control form-boxed" style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" placeholder=""  name="qq" class="form-control form-boxed" style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" placeholder="" name="wx" class="form-control form-boxed" style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" placeholder="" name="phone" class="form-control form-boxed" style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" placeholder="" name="address" class="form-control form-boxed" style="width:300px;">
                        </div>
                    </div>
...
<script>
    function ajax_submit() {
        ...
        $.post('<?php echo url("Admin/add_admin_do"); ?>', form_data, function (data) {
//            console.log(data);
            if (data.status == 200) {
                layer.msg(data.tips);
