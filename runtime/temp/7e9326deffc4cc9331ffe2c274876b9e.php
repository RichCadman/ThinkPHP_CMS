<?php /*a:6:{s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\system\config.html";i:1530710830;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\static.html";i:1529542576;s:63:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\menu.html";i:1528855708;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\header.html";i:1529387612;s:62:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\nav.html";i:1528625773;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\footer.html";i:1529573972;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
...
<script>
    ...
    <p class="title-description">
        <a href="">首页</a> > <a href=""><?php echo htmlentities($controller_name); ?></a> > <a href=""><?php echo htmlentities($action_name); ?></a>
                        ...
                        <!--<a href="<?php echo url('Admin/admin_index'); ?>"><button class="btn btn-primary fr icon-undo"><?php echo htmlentities(app('lang')->get('back')); ?></button></a>-->
                            ...
                            <div class="tab-cont" style="display: block;">
                                <form id="form_data">
                                    ...
                                    <div class="form-group-col-2">
                                        <div class="form-label">站点标题：</div>
                                        <div class="form-cont">
                                            <input type="text" value="<?php echo htmlentities($info['title']); ?>" name="title" class="form-control form-boxed" style="width:300px;">
                                        </div>
                                    </div>

                                    <div class="form-group-col-2">
                                        <div class="form-label" title="权限组管理员ID">权限组管理员ID：</div>
                                        <div class="form-cont">
                                            <input type="number" value="<?php echo htmlentities($info['admin_id']); ?>" name="admin_id" class="form-control form-boxed" style="width:300px;">
                                        </div>
                                    </div>

                                    <div class="form-group-col-2">
                                        <div class="form-label">前台地址：</div>
                                        <div class="form-cont">
                                            <input type="text" value="<?php echo htmlentities($info['home_url']); ?>" name="home_url" class="form-control form-boxed" style="width:300px;">
                                        </div>
                                    </div>

                                    <div class="form-group-col-2">
                                        <div class="form-label" title="评论是否需要审核">评论是否审核：</div>
                                        <div class="form-cont">
                                            <label class="radio">
                                                <input type="radio" name="check" value="1" <?php if(1 == $info['check']): ?>checked<?php endif; ?> />
                                                <span>是</span>
                                            </label>
                                            <label class="radio">
                                                <input type="radio" name="check" value="0" <?php if(0 == $info['check']): ?>checked<?php endif; ?> />
                                                <span>否</span>
                                            </label>
                                    ...
                                    <div class="form-group-col-2">
                                        <div class="form-label" title="唯一登陆">唯一登陆：</div>
                                        <div class="form-cont">
                                            <label class="radio">
                                                <input type="radio" name="check_login" value="1" <?php if(1 == $info['check_login']): ?>checked<?php endif; ?> />
                                                <span>开启</span>
                                            </label>
                                            <label class="radio">
                                                <input type="radio" name="check_login" value="0" <?php if(0 == $info['check_login']): ?>checked<?php endif; ?> />
                                                <span>关闭</span>
                                            </label>
                                    ...
                                    <!--<div class="form-group-col-2">-->
                                        ...
                                        <!--<div class="form-cont">-->
                                            <!--<label class="radio">-->
                                                <!--<input type="radio" name="status" value="1" <?php if(1 == ''): ?>checked<?php endif; ?>  />-->
                                                <!--<span>正常</span>-->
                                            <!--</label>-->
                                            <!--<label class="radio">-->
                                                <!--<input type="radio" name="status" value="0" <?php if(0 == ''): ?>checked<?php endif; ?> />-->
                                                <!--<span>禁止</span>-->
                                            <!--</label>-->
                            ...
                            <!--<div class="tab-cont">-->
                                <!--<form id="form_group">-->
                                    ...
                                    <!--<div class="form-group-col-2">-->
                                        ...
                                        <!--<div class="form-cont">-->
                                            <!--<input type="text" value="" name="username" class="form-control form-boxed" disabled style="width:300px;">-->
                                        <!--</div>-->
                                    <!--</div>-->
                                    ...
                                    <!--<div class="form-group-col-2">-->
                                        ...
                                        <!--<div class="form-cont" >-->
                                            <!--<select style="width:auto;" name="group_id">-->
                                                <!---->
                                                <!--<option value="<?php echo htmlentities($v['id']); ?>" <?php if($v['id'] == ''): ?>selected<?php endif; ?> >-->
                                                <!---->
                                                <!--</option>-->
                                                <!---->
                                            <!--</select>-->
                                    ...
                                    <!--<div class="form-group-col-2">-->
                                        ...
                                        <!--<div class="form-cont">-->
                                            ...
                                            <!--&lt;!&ndash;<input type="reset" class="btn btn-disabled" value="禁止" />&ndash;&gt;-->
                                        <!--</div>-->
                                    <!--</div>-->
                                <!--</form>-->
                            <!--</div>-->
...
//        ],
    ...
    function ajax_submit() {
        ...
        $.post('<?php echo url("System/editor_config_do"); ?>', form_data, function (data) {
//            console.log(data);
            if (data.status == 200) {
                layer.msg(data.tips);
                setTimeout("location.reload();",2000);
