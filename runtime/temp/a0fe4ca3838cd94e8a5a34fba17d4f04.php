<?php /*a:6:{s:62:"H:\web\ThinkPHP_CMS\application\admin\view\news\news_type.html";i:1529404463;s:61:"H:\web\ThinkPHP_CMS\application\admin\view\public\static.html";i:1529542576;s:59:"H:\web\ThinkPHP_CMS\application\admin\view\public\menu.html";i:1528855708;s:61:"H:\web\ThinkPHP_CMS\application\admin\view\public\header.html";i:1529387612;s:58:"H:\web\ThinkPHP_CMS\application\admin\view\public\nav.html";i:1528625773;s:61:"H:\web\ThinkPHP_CMS\application\admin\view\public\footer.html";i:1529573972;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
        ...
        <a href="">首页</a> > <a href=""><?php echo htmlentities($controller_name); ?></a> > <a href=""><?php echo htmlentities($action_name); ?></a>
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tr class="cen">
                        ...
                        <td class="lt"><?php echo htmlentities($v['news_type_name']); ?></td>
                        <td>
                    ...
                    <?php if($v['items']): if(is_array($v['items']) || $v['items'] instanceof \think\Collection || $v['items'] instanceof \think\Paginator): $i = 0; $__LIST__ = $v['items'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
                    <tr class="cen">
                        <td><?php echo htmlentities($v['id']); ?>--<?php echo htmlentities($vv['id']); ?></td>
                        <td class="lt">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            |--<?php echo htmlentities($vv['news_type_name']); ?>
                        </td>
                        <td>
                            <a href="/static/upload/<?php echo htmlentities($vv['news_type_img']); ?>" target="_blank">
                                <img src="/static/upload/<?php echo htmlentities($vv['news_type_img']); ?>" style="width: 50px;height: 50px;" alt="">
                            </a>
                        </td>
                        <td><?php echo htmlentities($vv['show_order']); ?></td>
                        <td><?php echo htmlentities($v['state']); ?></td>
                        <td>
                            <a href="javascript:void(0)" onclick="editor(this,<?php echo htmlentities($vv['id']); ?>)" title="<?php echo htmlentities(app('lang')->get('editor')); ?>" class="mr-5 icon-edit"><?php echo htmlentities(app('lang')->get('editor')); ?></a>
                            <!--<a title="详情" class="mr-5">详情</a>-->
                            <a href="javascript:void(0)" onclick="del(this,<?php echo htmlentities($vv['id']); ?>)" title="<?php echo htmlentities(app('lang')->get('del')); ?>" class="icon-trash"><?php echo htmlentities(app('lang')->get('del')); ?></a>
                        </td>
                    </tr>
