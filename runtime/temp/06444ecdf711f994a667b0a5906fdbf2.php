<?php /*a:6:{s:68:"E:\www-web\ThinkPHP_CMS\application\admin\view\news\editor_news.html";i:1529549991;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\static.html";i:1529542576;s:63:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\menu.html";i:1528855708;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\header.html";i:1529387612;s:62:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\nav.html";i:1528625773;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\footer.html";i:1529573972;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
        ...
        <a href="">首页</a> > <a href=""><?php echo htmlentities($controller_name); ?></a> > <a href=""><?php echo htmlentities($action_name); ?></a>
                ...
                <form id="form_data" enctype="multipart/form-data">
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" value="<?php echo htmlentities($info['title']); ?>" name="title" class="form-control form-boxed"
                                   style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" value="<?php echo htmlentities($info['short_title']); ?>" name="short_title" class="form-control form-boxed"
                                   style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" value="<?php echo htmlentities($info['author']); ?>" name="author" class="form-control form-boxed"
                                   style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="number" value="<?php echo htmlentities($info['click_num']); ?>" name="click_num" class="form-control form-boxed"
                                   style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <select style="width:auto;" name="news_type_id">
                                ...
                                <option value="<?php echo htmlentities($v['id']); ?>" disabled>|--<?php echo htmlentities($v['news_type_name']); ?></option>
                                <?php if($v['items']): if(is_array($v['items']) || $v['items'] instanceof \think\Collection || $v['items'] instanceof \think\Paginator): $i = 0; $__LIST__ = $v['items'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo htmlentities($vv['id']); ?>"  <?php if($vv['id'] == $info['news_type_id']): ?>selected<?php endif; ?>>&nbsp;&nbsp;&nbsp;&nbsp;|--<?php echo htmlentities($vv['news_type_name']); ?></option>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            ...
                            <input type="hidden" name="news_img" id="news_img" disabled="disabled" value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <a href="/static/upload/<?php echo htmlentities($info['news_img']); ?>" target="_blank">
                                <img src="/static/upload/<?php echo htmlentities($info['news_img']); ?>" style="width:200px;height:200px;" alt="">
                            </a>
                        </div>
                    </div>
                    <script>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" readonly id="create_time" value="<?php echo htmlentities($info['create_time']); ?>"  name="create_time" class="form-control form-boxed" style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <textarea name="short_content" id="" cols="30" rows="4" style="width:1200px;"><?php echo htmlentities($info['short_content']); ?></textarea>
...
<script>
    function ajax_submit() {
        ...
        $.post('<?php echo url("News/editor_news_do"); ?>', form_data, function (data) {
            if (data.status == 200) {
                layer.msg(data.tips);
