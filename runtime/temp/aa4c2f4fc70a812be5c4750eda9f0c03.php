<?php /*a:6:{s:68:"E:\www-web\ThinkPHP_CMS\application\admin\view\auth\group_index.html";i:1529550100;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\static.html";i:1529542576;s:63:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\menu.html";i:1528855708;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\header.html";i:1529387612;s:62:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\nav.html";i:1528625773;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\footer.html";i:1529573972;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
...
<script>
    ...
    <p class="title-description">
        <a href="">首页</a> > <a href=""><?php echo htmlentities($controller_name); ?></a> > <a href=""><?php echo htmlentities($action_name); ?></a>
                        ...
                        <script>
                            function add() {
                                $.get('<?php echo url("Auth/add_group"); ?>', function (data) {
                                    if (data.status == 400) {
                                        layer.msg(data.tips);
                                    } else {
                                        location.href = "<?php echo url('Auth/add_group'); ?>";
                                    }
                                })
                            }
                        </script>
...
<script type="text/javascript">
    ...
    function del(obj, id) {
        layer.confirm('确定删除吗？', {
            ...
            $.post('<?php echo url("Auth/del_group"); ?>', {id: id}, function (data) {
                // 判断是否成功
                if (data.status == 200) {
    ...
    function editor(obj, id) {
        $.get('<?php echo url("Auth/editor_group"); ?>',{id:id}, function (data) {
            // 判断是否成功
            if (data.status == 400) {
                layer.msg(data.tips);
            } else {
                location.href = "<?php echo url('Auth/editor_group'); ?>" + "?id=" + id;
            }
        });
    }
</script>
