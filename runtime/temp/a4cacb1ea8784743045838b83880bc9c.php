<?php /*a:6:{s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\news\add_news.html";i:1529545323;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\static.html";i:1529542576;s:63:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\menu.html";i:1528855708;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\header.html";i:1529387612;s:62:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\nav.html";i:1528625773;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\footer.html";i:1528353677;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <select style="width:auto;" name="news_type_id">
                                ...
                                <?php if($v['items']): if(is_array($v['items']) || $v['items'] instanceof \think\Collection || $v['items'] instanceof \think\Paginator): $i = 0; $__LIST__ = $v['items'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
                                        <option value="<?php echo htmlentities($vv['id']); ?>">&nbsp;&nbsp;&nbsp;&nbsp;|--<?php echo htmlentities($vv['news_type_name']); ?></option>
