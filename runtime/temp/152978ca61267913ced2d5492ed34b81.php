<?php /*a:6:{s:67:"E:\www-web\ThinkPHP_CMS\application\admin\view\comment\comment.html";i:1530710638;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\static.html";i:1529542576;s:63:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\menu.html";i:1528855708;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\header.html";i:1529387612;s:62:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\nav.html";i:1528625773;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\footer.html";i:1529573972;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
        ...
        <a href="">首页</a> > <a href=""><?php echo htmlentities($controller_name); ?></a> > <a href=""><?php echo htmlentities($action_name); ?></a>
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tr class="cen">
                        ...
                        <td title="<?php echo htmlentities($v['comment_content']); ?>"><?php echo htmlentities(csubstr($v['comment_content'],20,'utf-8')); ?></td>
                        <td><?php echo htmlentities($v['username']); ?></td>
                        <td><?php echo htmlentities($v['check_state']); ?></td>
                        <td>
                            <?php if($v['check_state'] == '未审核'): ?>
                                <a href="javascript:void(0)" onclick="no_check(this,<?php echo htmlentities($v['id']); ?>)" title="<?php echo htmlentities(app('lang')->get('no_check')); ?>" class="mr-5 icon-ban-circle"><?php echo htmlentities(app('lang')->get('no_check')); ?></a>
                            <?php else: ?>
                                <a href="javascript:void(0)" onclick="check_success(this,<?php echo htmlentities($v['id']); ?>)" title="<?php echo htmlentities(app('lang')->get('check_success')); ?>" class="mr-5 icon-check"><?php echo htmlentities(app('lang')->get('check_success')); ?></a>
                            <?php endif; ?>
                            <a href="javascript:void(0)" onclick="details(this,<?php echo htmlentities($v['id']); ?>)" title="<?php echo htmlentities(app('lang')->get('detail')); ?>" class="mr-5 icon-eye-open"><?php echo htmlentities(app('lang')->get('detail')); ?></a>
...
<script type="text/javascript">
    ...
    function del(obj, id) {
        layer.confirm('确定删除吗？', {
            ...
            $.post('<?php echo url("Comment/del_comment"); ?>', {id: id}, function (data) {
                // 判断是否成功
                if (data.status == 200) {
    ...
    function editor(obj, id) {
        $.get('<?php echo url("Comment/editor_comment"); ?>',{comment_id:id}, function (data) {
            // 判断是否成功
            if (data.status == 400) {
                layer.msg(data.tips);
            } else {
                location.href = "<?php echo url('Comment/editor_comment'); ?>" + "?comment_id=" + id;
            }
        });
    }
    ...
    function details(obj, id) {
        $.post('<?php echo url("Comment/details"); ?>',{comment_id:id}, function (data) {
    ...
    function no_check(obj, id) {
        layer.confirm('确定操作吗？', {
            ...
            $.post('<?php echo url("Comment/check_state"); ?>',{id:id,check_state:0}, function (data) {
                if(data.status == 200){
                    layer.msg(data.tips);
                    setTimeout("location.reload();",500);
                }else{
    ...
    function check_success(obj, id) {
        layer.confirm('确定操作吗？', {
            ...
            $.post('<?php echo url("Comment/check_state"); ?>',{id:id,check_state:1}, function (data) {
                if(data.status == 200){
                    layer.msg(data.tips);
                    setTimeout("location.reload();",500);
                }else{
