<?php /*a:6:{s:68:"E:\www-web\ThinkPHP_CMS\application\admin\view\auth\editor_rule.html";i:1529550095;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\static.html";i:1529542576;s:63:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\menu.html";i:1528855708;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\header.html";i:1529387612;s:62:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\nav.html";i:1528625773;s:65:"E:\www-web\ThinkPHP_CMS\application\admin\view\public\footer.html";i:1529573972;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
        ...
        <a href="">首页</a> > <a href=""><?php echo htmlentities($controller_name); ?></a> > <a href=""><?php echo htmlentities($action_name); ?></a>
                ...
                <form id="form_data">
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" placeholder="权限管理" name="title" value="<?php echo htmlentities($info['title']); ?>" class="form-control form-boxed" style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" placeholder="Admin/Auth" name="name" value="<?php echo htmlentities($info['name']); ?>" class="form-control form-boxed" style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont" >
                            <select style="width:auto;" name="p_id">
                                ...
                                <option value="<?php echo htmlentities($v['id']); ?>" <?php if($v['id'] == $info['p_id']): ?>selected<?php endif; ?> >|--<?php echo htmlentities($v['title']); ?></option>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" placeholder="权限管理" name="nav" value="<?php echo htmlentities($info['nav']); ?>" class="form-control form-boxed" style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <label class="radio">
                                <input type="radio" name="is_visible" value="1" <?php if(1 == $info['is_visible']): ?>checked<?php endif; ?>  />
                                <span>显示</span>
                            </label>
                            <label class="radio">
                                <input type="radio" name="is_visible" value="2" <?php if(2 == $info['is_visible']): ?>checked<?php endif; ?> />
                                <span>隐藏</span>
                            </label>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" placeholder="icon-leaf" name="icon" value="<?php echo htmlentities($info['icon']); ?>" class="form-control form-boxed " style="width:300px;">
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" placeholder="Auth" name="controller" value="<?php echo htmlentities($info['controller']); ?>" class="form-control form-boxed" style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="text" placeholder="auth" name="function" value="<?php echo htmlentities($info['function']); ?>" class="form-control form-boxed" style="width:300px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont">
                            <input type="number" placeholder="越大越靠前" name="show_order" value="<?php echo htmlentities($info['show_order']); ?>" class="form-control form-boxed" style="width:300px;">
                        </div>
                    </div>
...
<div class="dialog" style="width: 1400px;">
    <div class="dialog-hd">
        <strong class="lt-title">系统图标</strong>
...
<script>
    function ajax_submit() {
        ...
        $.post('<?php echo url("Auth/editor_rule_do"); ?>', form_data, function (data) {
//            console.log(data);
            if (data.status == 200) {
                layer.msg(data.tips);
