...
<div class="ibody">
    <header>
        ...
        <nav id="topnav"><a href="index.html">首页</a><a href="html/about.html">关于我</a><a href="html/newsList.html">慢生活</a><a
                    href="html/share.html">模板分享</a><a href="html/new.html">模板主题</a></nav>
    </header>
    <article>
        <h2 class="about_h">您现在的位置是：<a href="/">首页</a>><a href="1/">模板分享</a>><a href="1/">个人博客模板</a></h2>
        <div class="index_about">
            <h2 class="c_titile"><?php echo $newsDetail['title'] ?></h2>
            <p class="box_c"><span
                        class="d_time">发布时间：<?php echo $newsDetail['create_time'] ?></span><span>编辑：<?php echo $newsDetail['author'] ?></span><span id="click_num">浏览（390）</span><span>评论览（14）</span>
            </p>
            <ul class="infos">
    ...
    <aside>
        ...
        <div class="ph_news">
            ...
            <ul class="pl_n">
                <dl>
                    <dt><img src="../static/index/images/s8.jpg"></dt>
                    <dt></dt>
                    <dd>DanceSmile
                        <time>49分钟前</time>
                    </dd>
                ...
                <dl>
                    <dt><img src="../static/index/images/s7.jpg"></dt>
                    <dt></dt>
                    <dd>yisa
                        <time>2小时前</time>
                    </dd>
                ...
                <dl>
                    <dt><img src="../static/index/images/s6.jpg"></dt>
                    <dt></dt>
                    <dd>小林博客
                        <time>8月7日</time>
                    </dd>
                ...
                <dl>
                    <dt><img src="../static/index/images/003.jpg"></dt>
                    <dt></dt>
                    <dd>DanceSmile
                        <time>49分钟前</time>
                    </dd>
                ...
                <dl>
                    <dt><img src="../static/index/images/002.jpg"></dt>
                    <dt></dt>
                    <dd>yisa
                        <time>2小时前</time>
                    </dd>
            ...
            <h2>
                <p>最近访客</p>
                <ul>
                    <img src="../static/index/images/vis.jpg"><!-- 直接使用“多说”插件的调用代码 -->
                </ul>
            </h2>
        </div>
        <div class="copyright">
...
<script>
    //异步加载点击量
    $(function () {
        var id = <?php echo $newsDetail['id'] ?>;
        $.post('<?php echo $host . "/Index/onloadClickNum"; ?>', {id: id}, function (data) {
            $('#click_num').html("浏览（"+data.click_num+"）");
        })
    })
</script>
</body>
