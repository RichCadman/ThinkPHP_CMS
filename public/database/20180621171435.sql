...
-- ----------------------------
INSERT INTO `cms_admin` (`id`,`username`,`password`,`unique_id`,`last_time`,`login_count`,`status`,`qq`,`wx`,`phone`,`address`,`intro`) VALUES ('1','admin','202cb962ac59075b964b07152d234b70','63212','2018-06-21 08:57:02','16','1','417626953','lqm_956','18100386352','济南','<p>帅！！！</p><p><br/></p>');
...
CREATE TABLE `cms_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 COMMENT='日志表';
-- ----------------------------
-- Records of cms_log
-- ----------------------------
