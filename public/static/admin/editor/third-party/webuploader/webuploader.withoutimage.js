...
(function( root, factory ) {
    ...
    define('base',[
        ...
        return {
             ...
             *
             * // 子类的__super__属性指向父类
             * console.login( Manager.__super__ === Person );    // => true
             */
            ...
            /**
             * 引用Console.log如果存在的话，否则引用一个[空函数loop](#WebUploader:Base.login)。
             * @grammar Base.login( args... ) => undefined
             * @method login
             */
            log: (function() {
                if ( window.console ) {
             ...
             * @example
             * console.login( Base.formatSize( 100 ) );    // => 100B
             * console.login( Base.formatSize( 1024 ) );    // => 1.00K
             * console.login( Base.formatSize( 1024, 0 ) );    // => 1K
             * console.login( Base.formatSize( 1024 * 1024 ) );    // => 1.00M
             * console.login( Base.formatSize( 1024 * 1024 * 1024 ) );    // => 1.00G
             * console.login( Base.formatSize( 1024 * 1024 * 1024, 0, ['B', 'KB', 'MB'] ) );    // => 1024MB
             */
    ...
    define('mediator',[
        ...
        protos = {
             ...
             *     console.login( arg1, arg2 ); // => 'arg1', 'arg2'
             * });
             *
             ...
             *     console.login( type, arg1, arg2 ); // => 'testa', 'arg1', 'arg2'
             * });
             * ```
             *
             * @method on
    ...
    define('widgets/queue',[
        ...
        return Uploader.register({
             ...
             * @for  Uploader
             * @example
             * console.login( uploader.getFiles() );    // => all files
             * console.login( uploader.getFiles('error') )    // => all error files.
             */
            getFiles: function() {
    ...
    define('runtime/flash/runtime',[
        ...
        function FlashRuntime() {
            ...
            function handler( evt, obj ) {
                ...
                // console.login.apply( console, arguments );
