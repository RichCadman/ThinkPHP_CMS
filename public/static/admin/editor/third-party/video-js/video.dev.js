...
// usage: login('inside coolFunc',this,arguments);
...
//   vjs.login('unloadingTech')
//   this.unloadTech();
//   vjs.login('unloadedTech')
//   if (betweenFn) { betweenFn.call(); }
//   vjs.login('LoadingTech')
//   this.loadTech(this.techName, { src: this.cache_.src })
//   vjs.login('loadedTech')
// },
...
vjs.Player.prototype.trackProgress = function(){
  ...
  this.progressInterval = setInterval(vjs.bind(this, function(){
    ...
    // login(this.cache_.bufferEnd, this.buffered().end(0), this.duration())
...
vjs.ChaptersTrackMenuItem.prototype.update = function(){
  ...
  // vjs.login(currentTime, cue.startTime);
